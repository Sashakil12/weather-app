...
const forecast = (lattitude, longitude, callback) => {
    const url = 'https://api.darksky.net/forecast/a14f6f456bfe35627642f442cc6fedf0/' + encodeURIComponent(lattitude) + ',' + encodeURIComponent(longitude) +'?exclude=minutely,hourly,daily&lang=en&units=si';
